...
//-- GPL license
//--------------------------------------------------------------
//-- Added servos controlled with PCA9685 by Javier Vargas
...
void Oscillator::pwmMINMAX(int SERVOMIN_, int SERVOMAX_)
{
SERVOMIN = SERVOMIN_;
SERVOMAX = SERVOMAX_;
...
void Oscillator::SetServo(int angulo) {
  angulo = constrain(angulo, 0, 180);
  pwm.setPWM(ServoDir, 0, map(angulo, 0, 180, SERVOMIN, SERVOMAX));
}
